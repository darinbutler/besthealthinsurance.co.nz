      ...
      <section className="py-16 lg:py-20 px-4 lg:px-8">
        <div className="max-w-4xl mx-auto space-y-8 text-gray-300">
          ...
          <div className="bg-gray-800 rounded-lg p-8 border border-gray-700">
            ...
            <p className="leading-relaxed mt-4">The cost of this service is met by the underwriter, through the broker who places the policy. It is never met by you. It also does not add anything to your premium: commission is already built into the insurer&apos;s standard pricing, and it is there whether you use a broker or buy direct. Declining advice does not refund that component of the price, so for cover sold through brokers there is no saving in going it alone.</p>
