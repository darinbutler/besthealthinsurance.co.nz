      ...
      <div className="bg-gray-50 py-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <section className="bg-gray-900 rounded-2xl p-8 lg:p-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {[
                ...
                { step: '2', title: 'We Refer You', body: 'We pass your details to one of a number of specialist trusted brokers and underwriters we have already vetted. That referral is the whole of our role.' },
                { step: '3', title: 'They Compare', body: 'Your broker compares the insurers they hold an agency with, against your situation and your medical history.' },
                { step: '4', title: 'You Decide', body: 'You receive quotes and your broker\'s recommendation. Take your time, ask questions, decide in your own time.' },
              ].map((item) => (
          ...
          <section className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 lg:p-12">
            <h2 className="text-2xl font-extrabold text-gray-900 mb-3">How We Vet the Brokers and Underwriters We Work With</h2>
            <p className="text-gray-600 leading-relaxed mb-6">
              Cover4You does not hold a financial advice licence and does not give advice. That
              makes the one thing we do control &mdash; who your enquiry goes to &mdash; the thing we
              take most seriously. We work with a number of specialist trusted brokers and
              underwriters, and before any of them receives a single enquiry from this site we check
              the following, and we check it again periodically.
            </p>
            ...
            <p className="text-gray-500 text-xs mt-6 leading-relaxed">
              None of this makes us the adviser. Cover4You holds no financial advice licence. The
              advice is your broker&rsquo;s, they are responsible for it, and they are the ones
              licensed to give it. What we are responsible for is not sending you to someone who
              should not be receiving your enquiry in the first place.
            </p>
          </section>
