        ...
        <div className="max-w-4xl mx-auto">
          <div className="space-y-8 text-gray-300">
            ...
            <div>
              ...
              <p className="leading-relaxed mt-4">We are paid by referral. When you submit an enquiry we pass your details to one of the specialist brokers or underwriters we work with. If you go on to take out a policy, the insurer pays a commission to that broker, and we receive a share of it or a referral fee. Commission is built into the insurer&apos;s standard pricing and is the same whether you buy through a broker or go direct, so being referred by us does not increase what you pay.</p>
              <p className="leading-relaxed mt-4">We want to be plain about this: some of the providers, brokers and underwriters we work with reward us for the enquiries we send them, and that is what pays for this site and allows us to keep publishing it. Those arrangements are not the same across every provider. Some reward us, some do not, and some we have no arrangement with at all.</p>
