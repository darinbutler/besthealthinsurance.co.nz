      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="border-t border-gray-800 pt-8">
          <p className="text-gray-500 text-xs leading-relaxed mb-3">
            <strong className="text-gray-400">How This Site Works:</strong> BestHealthInsurance.co.nz is operated by Cover4You Group. We publish information about health insurance from major New Zealand providers. We do not compare policies for you, we do not recommend an insurer, and we do not give financial advice. When you submit a quote request we pass your details to one of a number of specialist trusted brokers and underwriters we work with. Where that is a broker, they are a licensed New Zealand financial adviser who will contact you, compare policies and give you any advice. Where an insurer takes enquiries directly, you deal with their own team about their own products. We vet every broker and underwriter before we refer them a single enquiry, and we review that vetting. If you take out a policy, the insurer pays a commission to the broker who placed it and we receive a share of it. The cost of this service is met by the underwriter, never by you, and it does not add anything to your premium: commission is built into the insurer's standard pricing whether you use a broker or buy direct.
          </p>
          <p className="text-gray-500 text-xs leading-relaxed mb-4">
            <strong className="text-gray-400">Our Standard:</strong> Every Cover4You partner broker is a licensed Financial Advice Provider, registered on the Financial Service Providers Register and a member of an approved dispute resolution scheme. We confirm all three before we refer a single enquiry, and we hold their registration details on file. They are independent firms, which is precisely why the advice is theirs and they stand behind it. Cover4You Group itself holds no financial advice licence and gives no financial advice. This site provides general information only. Please read any policy disclosure statement before purchasing insurance, and ask your broker for their own disclosure information, which sets out their licence, the providers they work with, how they are paid and how to complain.
          </p>
